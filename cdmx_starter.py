...
import numpy as np
# Read the training data for CdMX bike sharing system
source,target = read_train_csv('data/cdmx_data_series_train.csv')
...
# Read the test data for CdMX bike sharing system
test = read_test_csv('data/cdmx_data_series_test_no_occupation.csv')
